...
public class ModMessages {
    ...
    public static void register(){
        ...
        net.messageBuilder(MinoshroomS2CPacket.class,id(), NetworkDirection.PLAY_TO_CLIENT)
                .decoder(MinoshroomS2CPacket::new)
                .encoder(MinoshroomS2CPacket::toBytes)
                .consumerMainThread(MinoshroomS2CPacket::handle)
                .add();
    }
